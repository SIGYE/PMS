...
# Load YOLOv8 model
model = YOLO('C:/Users/Linda/Desktop/notes/y3/Robotics/parking-management-system/parking-management-system/best.pt')
...
def detect_arduino_port():
    ...
    for port in ports:
        if "COM3" in port.device or "wchusbmodem" in port.device:
            return port.device
    return None
